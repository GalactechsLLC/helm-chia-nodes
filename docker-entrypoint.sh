...
if [[ ${use_checkpoint} == 'true' ]]; then
  if [[ ${testnet} == 'true' ]]; then
    checkpoint_url="${testnet_checkpoint_url:-https://torrents.chia.net/databases/testnet11/testnet11.2026-04-01.tar.gz.torrent}"
    ...
    checkpoint_url="${mainnet_checkpoint_url:-https://torrents.chia.net/databases/mainnet/mainnet.2026-04-01.tar.gz.torrent}"
